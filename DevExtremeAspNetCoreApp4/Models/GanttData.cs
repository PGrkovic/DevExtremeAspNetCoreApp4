...
using GanttTask = DevExtremeAspNetCoreApp4.Models.Gantt.GanttTask;
...
namespace DevExtremeAspNetCoreApp4.Models
{
    public partial class SampleData
    {
        ...
        public static readonly IEnumerable<GanttTask> GanttTasks = new[] {
            new GanttTask {
                ID = 1,
                ParentId = 0,
        ...
        public static readonly IEnumerable<GanttTask> GanttTasksJohnsonResidence = new[] {
            new GanttTask {
                ID = 1,
                ParentId = 0,
        ...
        public static readonly IEnumerable<GanttTask> GanttTasksRequirements = new[] {
            new GanttTask {
                ID = 1,
                ParentId = 0,
                Title = "Analysis/Software Requirements",
